from multiprocessing import Value, current_process, Process
...
if __name__ == '__main__':
    ...
    processes = [Process(target=num_shard, args=(shard_counter,), name=f'process-{i}')  for i in range(0, 3000)]
    print(len(processes))
    for p in processes:
        p.start()
